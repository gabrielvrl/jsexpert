...
describe('Test suite for Template Method design patterns', () => {
  beforeEach(() => {
  ...
  describe('#OrderBusiness', () => {
    test('Execution Order Business without Template Method', () => {
      ...
      // nesse pattern todos os devs devem obrigatoriamente  lembrar de seguir a risca esse fluxo de execução
