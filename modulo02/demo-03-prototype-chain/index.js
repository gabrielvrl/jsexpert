...
// console.log('Manager.salary()', Manager.salary()); // error
...
console.log(Manager.prototype.salary() === new Manager().__proto__.salary()); // true
console.log(Manager.prototype.profitShare() === new Manager().__proto__.profitShare()); // true
...
console.log(manager.__proto__) // MonthlyBonuses
console.log(manager.__proto__.__proto__) // profitShare 
console.log(manager.__proto__.__proto__.__proto__) // salary
