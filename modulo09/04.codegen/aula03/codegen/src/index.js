...
import { createFiles } from '../../../aula03/codegen/src/createFiles.js';
import { createLayersIfNotExists } from '../../../aula03/codegen/src/createLayers.js';
...
const { argv: { componentName } } = yargs(hideBin(process.argv))
  ...
  .epilog('copyright 2023 - Gabriel Varela Corporation');
